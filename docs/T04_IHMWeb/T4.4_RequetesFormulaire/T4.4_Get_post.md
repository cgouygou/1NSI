    ...
    === "Page dynamique"
        ...
        !!! example "{{ exercice() }}"
            === "Énoncé" 
                ...
                2. Afficher le code source de la page et le comparer au code `php` précédent. On constate que la balise `#!php <?php?>` a produit du code HTML, à la demande (ici une simple consultation de la page) du client.
            === "Correction" 
                {{ correction(False, 
                "
                "
