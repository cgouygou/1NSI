...
!!! example "{{ exercice() }}"
    === "Énoncé" 
        En console, calculer la racine carrée de 25, puis de 2.

        La racine carrée (square root in english) se trouve dans le module `math`. La chercher dans ce module, qu'il faudra importer.
    === "Solution" 
        {{ correction(False, 
        "
