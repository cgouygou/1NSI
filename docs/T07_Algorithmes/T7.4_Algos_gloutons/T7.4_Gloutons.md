...
!!! gear "Force brute"
    ...
    Pour explorer efficacement tous les sous-ensembles possibles, on remarque d'abord qu'ils sont au nombre de $2^n$ (où $n$ est le nombre total d'objets) : pour chaque objet, soit on le prend, soit on le prend pas, c'est-à-dire 2 choix pour chaque objet.
    ...
    ```python linenums='1' title='Fonctions ultra-pythonienne, à méditer'
